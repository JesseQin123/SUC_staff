...
const MENU_ITEM_CLASS =
  'w-[110px] cursor-pointer gap-[4px] rounded-[10px] px-[12px] py-[6px] text-[12px] text-[#858b9c] focus:text-[#18181a] dark:text-muted-foreground dark:focus:text-white [&_svg]:size-[14px]';
const MENU_ITEM_DANGER_CLASS =
  'w-[110px] cursor-pointer gap-[4px] rounded-[10px] px-[12px] py-[6px] text-[12px] text-[#d20b0b] focus:bg-[#fce7e7] focus:text-[#d20b0b] focus:[&_svg]:text-[#d20b0b]! dark:text-[#ff6b6b] dark:focus:bg-[#d20b0b]/20 dark:focus:text-[#ff6b6b] dark:focus:[&_svg]:text-[#ff6b6b]! [&_svg]:size-[14px]';
...
export function TaskActionsMenu({
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        aria-label="操作"
        className="grid size-7 place-items-center rounded-[8px] text-[#1a71ff] transition-colors outline-none hover:bg-black/5 hover:text-[#4a8dff] focus-visible:bg-black/5 dark:hover:bg-white/10"
      >
        <IconMore className="size-3.5" />
      </DropdownMenuTrigger>
      <DropdownMenuContent
        align="end"
        className="flex w-auto min-w-0 flex-col gap-[4px] rounded-[14px] border-0 bg-white p-[4px] shadow-[0px_0px_8px_rgba(0,0,0,0.1)] ring-0 [--accent:#F6F6F6] [--accent-foreground:#18181A] dark:bg-[#26272d] dark:[--accent:#2f3136] dark:[--accent-foreground:#ffffff]"
      >
